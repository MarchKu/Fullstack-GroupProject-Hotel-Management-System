...
const About = () => {
  ...
  return (
    <section className="flex flex-col w-full h-[150vh] pt-[6%] pb-[4%]">
      <div className="w-full h-[50%] flex flex-col gap-10 px-[10%]">
        <h1 className="font-heading text-[7rem] text-primary-foreground text-primary-heading">Neatly Hotel</h1>
        <div className="flex flex-col font-body pl-[20%] pt-10 text-[2rem] text-gray-700 gap-[1.5rem]">
          <p>
