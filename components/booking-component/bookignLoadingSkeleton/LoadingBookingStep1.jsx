    ...
    <div className="w-full p-4 lg:px-8 xl:px-28 pb-8 md:pb-32 ">
      <div className="w-full relative">
        <div className="w-full p-4 flex flex-col gap-8 md:mt-8  md:w-[50%] lg:w-[60%] xl:w-[60%] md:p-8 md:border  bg-white">
          ...
          <div>
            <Skeleton className="block text-muted-foreground mb-1 w-[240px] h-[1.25rem]"></Skeleton>
            <Skeleton className="w-full p-2 rounded h-[2rem]" />
          </div>
          <div>
            <Skeleton className="block text-muted-foreground mb-1 w-[240px] h-[1.25rem]"></Skeleton>
            <Skeleton className="w-full p-2 rounded h-[2rem]" />
...
export default LoadingBookingStep1;
