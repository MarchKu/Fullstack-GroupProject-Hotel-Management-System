        ...
        <div className="w-full p-4 flex flex-col gap-8 md:mt-8  md:w-[50%] lg:w-[60%] xl:w-[60%] md:p-8 md:border  bg-white">
          <div className="w-full flex flex-col">
            <div className="w-full gap-4 mb-8 flex lg:gap-12  justify-between">
              <Skeleton className="max-w-[250px] w-full h-[4rem]"></Skeleton>
              <Skeleton className="max-w-[250px] w-full h-[4rem]"></Skeleton>
            </div>

            <div className="lg:px-12 xl:px-10 flex flex-col gap-2">
              <Skeleton className="w-[150px] h-[1.3rem]"></Skeleton>
              <Skeleton className="max-w-full h-[2rem]"></Skeleton>
            </div>
          </div>
...
export default LoadingBookingStep3;
